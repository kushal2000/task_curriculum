"""Procedural handle-head URDF generation for Play.

Clean port of the minimal subset of isaacgymenvs/tasks/play/generate_objects.py
...
def generate_handle_head_urdfs(
    ...
    out_dir: Union[str, Path] = "/tmp/play_assets",
    ...
    isaacgymenvs/tasks/play/env.py:1706-1840:
