...
DEFAULT_GITHUB_RAW_BASE = "https://raw.githubusercontent.com/tylerlum/play/6809a978753e950913a7588bbeaef07d16f10b56/"
...
def write_pose_viewer_html(path: Path, payload: dict, *, title: str) -> str:
    ...
    del title  # The Play template reads the title from embedded trajectory data.
    ...
    # Placeholder object mesh for the HTML viewer (Stage-1 play uses procedurally
    # generated objects, so this is only a stand-in glyph in the rollout viewer).
    object_urdf_url = (
        github_raw_base
        + "assets/urdf/peg_in_hole/lpeg_matchedmass/lpeg_matchedmass.urdf"
    )
